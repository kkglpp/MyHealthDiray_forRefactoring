...
import 'package:myhealthdiary_app/managerClass/DoubleValueAlertManager.dart';
import 'package:myhealthdiary_app/managerClass/pickDateMethod.dart';
        ...
        children: [
          ...
          GestureDetector(
            onTap: () async {
              ...
              //입력은 alert 창에서 받자/
              if(date){
                DateTime newdate = await pickDateUsingDialog(context,onlyDay(DateTime.now()));
