...
final sortFolderStateProvider =
    StateNotifierProvider<SortFolderStateNotifier, SportFolderModel>((ref) {
...
final folderStateForDeleteProvider =
    StateNotifierProviderFamily<SortFolderStateNotifier, SportFolderModel, int>(
        (ref, id) {
